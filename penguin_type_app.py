...
# Design the App
# Add title widget
st.sidebar.title("Penguin Type Prediction App")  
...
bill_depth_mm = st.sidebar.slider("bill_depth_mm", 10.0, 13.1)
flipper_length_mm = st.sidebar.slider("flipper_length_mm", 0.0, 10.0)  
body_mass_g = st.sidebar.slider("body_mass_g", 0.0, 10.0)
